...
<div class="content">
    ...
    <p>
        This app was created to help a friend of mine solve the puzzles because she could not solve them ;).
    </p>

    <p>
        This is a small side project because it peaked my interest.
    </p>
